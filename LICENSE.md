...
> BetterDiscord plugins pack, 80+ useful plugins 2026 — free, open-source, easy to set up.

<br>

## ✨ Features

🔌 &nbsp;**80+ plugins** — curated best BetterDiscord plugins

🛡️ &nbsp;**Privacy** — hide online status, typing indicators

🎨 &nbsp;**UI** — customize fonts, colors, layouts

📋 &nbsp;**Utility** — copy IDs, timestamps, server info

🔊 &nbsp;**Voice** — push-to-talk, audio tweaks

📦 &nbsp;**Easy install** — copy to BD plugins folder
